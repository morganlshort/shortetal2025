...
legend("topright", inset = c( -0.35, 0), legend =c(expression(italic("Siderastrea siderea")~'host'),'Endosymbiont','POM','Zooplankton'), 
       pch=c(15,15,18,8),  
...
legend("topright", inset = c( -0.4, 0), legend =c(expression(italic("Siderastrea siderea")~'host'),'Endosymbiont','POM','Zooplankton'), 
       pch=c(15,15,18,8),  
